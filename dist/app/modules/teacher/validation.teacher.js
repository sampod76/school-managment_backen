    ...
    body: zod_1.z.object({
        ...
        teacher_info: zod_1.z.object({
            ...
            phone_number: zod_1.z
                ...
                .max(20)
                .trim(),
            opinion: zod_1.z.string().max(3000).trim().optional(),
        }),
        mother_info: zod_1.z.object({
            ...
            profession: zod_1.z
                ...
                .max(50)
                .trim(),
            year_of_death: zod_1.z.string().max(50).trim(),
        }),
        ...
        previous_experience: zod_1.z.array(zod_1.z.object({
            ...
            subject: zod_1.z.array(zod_1.z
                ...
                .max(50)
                .trim()),
            employment_period: zod_1.z.array(zod_1.z.string().max(50).trim()).optional(),
        })).optional(),
        training_courses: zod_1.z.array(zod_1.z.object({
            course_name: zod_1.z
                ...
                .max(50)
                .trim(),
            course_subject: zod_1.z.string().max(50).trim().optional(),
            course_duration: zod_1.z.array(zod_1.z.string().max(50).trim()).optional(),
            course_details: zod_1.z.string().max(50).trim().optional(),
            certificate_upload: zod_1.z.string().max(50).trim().optional(),
        })).optional(),
    ...
    body: zod_1.z.object({
        ...
        teacher_info: zod_1.z.object({
            ...
            subject: zod_1.z.array(zod_1.z
                ...
                .trim()
                .optional()),
            marital_status: zod_1.z.enum([...userConstant_1.MARITAL_STATUS_VALUES]).optional(),
            blood_group: zod_1.z
                .enum([...userConstant_1.BLOOD_GROUP_TYPE_VALUES])
                .optional(),
            photo: zod_1.z
                ...
                .trim()
                .optional(),
            minority_ethnicity: zod_1.z.enum([...userConstant_1.YN_VALUES]).optional(),
            opinion: zod_1.z.string().max(1000).trim().optional(),
        }).optional(),
        mother_info: zod_1.z.object({
            name_bangla: zod_1.z
                .string()
            ...
            profession: zod_1.z
                ...
                .trim()
                .optional(),
            year_of_death: zod_1.z.string().max(50).trim().optional(),
        }).optional(),
        father_info: zod_1.z.object({
            name_bangla: zod_1.z
                .string()
        ...
        training_courses: zod_1.z.array(zod_1.z.object({
            course_name: zod_1.z
                ...
                .trim()
                .optional(),
            course_subject: zod_1.z.string().max(255).trim().optional(),
            course_duration: zod_1.z
                .string()
                .max(50)
                .trim()
                .optional(),
            course_details: zod_1.z.string().max(255).trim().optional(),
            certificate_upload: zod_1.z.string().max(255).trim().optional(),
        })).optional(),
