  ...
  body: z.object({
    ...
    mother_info: z.object({
      ...
      profession: z
        ...
        .max(50)
        .trim(),
      year_of_death: z.string().max(50).trim(),
    }),
    ...
    previous_experience: z.array(
      z.object({
        ...
        employment_period: z.array(z.string().max(50).trim()).optional(),
      })
    ).optional(),
    training_courses: z.array(
      z.object({
        course_name: z
          ...
          .max(50)
          .trim(),
        course_subject: z.string().max(50).trim().optional(),
        course_duration: z.array(z.string().max(50).trim()).optional(),
        course_details: z.string().max(50).trim().optional(),
        certificate_upload: z.string().max(50).trim().optional(),
      })
    ).optional(),
    password: z.string(),
  ...
  body: z.object({
    ...
    teacher_info: z.object({
      ...
      photo: z
        ...
        .trim()
        .optional(),
      minority_ethnicity: z.enum([...YN_VALUES] as [string, ...string[]]).optional(),
      opinion: z.string().max(1000).trim().optional(),
    }).optional(),
    mother_info: z.object({
      name_bangla: z
        .string()
      ...
      profession: z
        ...
        .trim()
        .optional(),
      year_of_death: z.string().max(50).trim().optional(),
    }).optional(),
