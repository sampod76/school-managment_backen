  ...
  body: z.object({
    ...
    teacher_info: z.object({
      ...
      opinionphone_number: z
        ...
        .max(20)
        .trim(),
      opinion: z.string().min(1).max(50).trim().optional(),
    }),
    ...
    previous_experience: z.array(
      z.object({
        ...
        employment_period: z.array(z.string().min(1).max(50).trim()),
      })
    ),
    training_courses: z.array(
      z.object({
        ...
        course_duration: z.array(z.string().min(1).max(50).trim()),
...
const updateTeacherZodSchema = z.object({
  body: z.object({
    ...
    teacher_info: z.object({
      ...
      birth_district: z
        .string({
          required_error: " জন্ম জেলা বাধ্যতামূলক প্রয়োজন",
        })
        .min(1)
        .max(50)
        .trim(),
      ...
      nationality: z
        .string({
          required_error: "জাতীয়তা বাধ্যতামূলক প্রয়োজন",
        })
        .min(1)
        .max(50)
        .trim(),
      ...
      photo: z
        .string({
          required_error: "ছবি বাধ্যতামূলক প্রয়োজন",
        })
        .min(1)
        .max(255)
        .trim(),
    ...
    guardian_info: z
      .object({
        name: z.string({
          required_error: "নাম  বাধ্যতামূলক প্রয়োজন",
        }),
        nid: z.string().optional(),
        profession: z.string().optional(),
        relationship: z.string({
    ...
    previous_experience: z.array(
      z.object({
        ...
        employment_period: z
          .string({
            required_error: "সময়সীমা বাধ্যতামূলক প্রয়োজন",
          })
          .min(1)
          .max(50)
          .trim(),
    ...
    training_courses: z.array(
      z.object({
        ...
        course_duration: z
          .string({
            required_error: "কোর্সের সময়সীমা বাধ্যতামূলক প্রয়োজন",
          })
          .min(1)
          .max(50)
          .trim(),
